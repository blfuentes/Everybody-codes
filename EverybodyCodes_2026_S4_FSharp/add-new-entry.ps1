...
try {
    ...
    $fsprojPath = Join-Path $scriptDir "EverybodyCodes_2026_S4_FSharp.fsproj"
    if (-not (Test-Path $fsprojPath)) { throw "Project file 'EverybodyCodes_2026_S4_FSharp.fsproj' not found in $scriptDir" }
