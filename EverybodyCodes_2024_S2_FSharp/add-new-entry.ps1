...
try {
    ...
    $fsprojPath = Join-Path $scriptDir "EverybodyCodes_2024_S2_FSharp.fsproj"
    if (-not (Test-Path $fsprojPath)) { throw "Project file 'EverybodyCodes_2024_S2_FSharp.fsproj' not found in $scriptDir" }
