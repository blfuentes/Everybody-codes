...
try {
    ...
    $fsprojPath = Join-Path $scriptDir "EveryBodyCodes_2026_GridOS1_FSharp.fsproj"
    if (-not (Test-Path $fsprojPath)) { throw "Project file 'EveryBodyCodes_2026_GridOS1_FSharp.fsproj' not found in $scriptDir" }
