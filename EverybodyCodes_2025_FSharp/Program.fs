...
let main argv =
    ...
    //let (resultquest08Part2_visualization, time08_2_visualization) = duration quest08_part02_visualization.execute
    //printfn "Final result Quest 08 part 2 visualization: %A in %s" resultquest08Part2_visualization (ms time08_2_visualization)
    ...
    //let (resultquest08Part3_optimized, time08_3_optimized) = duration quest08_part03_optimized.execute
    //printfn "Final result Quest 08 part 3 optimized: %A in %s" resultquest08Part3_optimized (ms time08_3_optimized)
    //let (resultquest08Part3_visualization, time08_3_visualization) = duration quest08_part03_visualization.execute
    //printfn "Final result Quest 08 part 3 visualization: %A in %s" resultquest08Part3_visualization (ms time08_3_visualization)
    ...
    //let (resultquest09Part3_visualization, time09_3_visualization) = duration quest09_part03_visualization.execute
    //printfn "Final result Quest 09 part 3 visualization: %A in %s" resultquest09Part3_visualization (ms time09_3_visualization)
